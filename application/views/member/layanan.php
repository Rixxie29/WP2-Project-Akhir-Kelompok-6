                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card shadow-sm">
                            <div class="card-body p-0 d-flex justify-content-center flex-column align-items-center">
                                <img src="<?= base_url('assets/gambar/' . $ly->gambar) ?>" height="150px"
                                    class="format-img">
                                <p class="format-nama"><?= $ly->nama_paket ?></p>
                                <p class=" harga">Rp. <span
                                        class="format-harga"><?= number_format($ly->harga, 0, ',', '.') ?></span></p>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex flex-row align-items-center">
                                        <div>
                                            <img src="<?= base_url('assets/gambar/' . $items['image']) ?>"
