    ...
    <header class="header position-relative bg-white shadow-sm" id="header">
        ...
        <div class="d-flex align-items-center">
            <div class="profile" onclick="menu()" style="cursor: pointer;">
                ...
                <img src="<?= base_url('assets/img/avtr.png') ?>" width="40px" height="40px">
            </div>
            <div class="menu shadow">
                <h3><?= $this->session->userdata('nama') ?><br><span><?= $this->session->userdata('username') ?></span>
                </h3>
                <ul>
                    <li>
                        <ion-icon name="person-circle-outline"></ion-icon></i><a
                            href="<?= base_url('member/ubahProfile') ?>">Ubah Profil</a>
                    </li>
