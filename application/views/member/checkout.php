<div class="l-navbar" id="nav-bar">
    <nav class="nav">
        <div>
            ...
            <div class="nav_list">
                <a href="<?= base_url('member/dashboard') ?>" class="nav_link"> <i class='bx bx-grid-alt nav_icon'></i>
                ...
                <a href="<?= base_url('member/pesanan') ?>" class="nav_link">
                    <ion-icon name="cart-outline" class="nav_icon"></ion-icon> <span class="nav_name">Pesanan
                        Saya</span>
                </a>
            </div>
        </div>
        <a href="<?= base_url('member/logout') ?>" class="nav_link"> <i class='bx bx-log-out nav_icon'></i> <span
        ...
        <form action="<?= base_url('member/layanan/proses-pembayaran') ?>" method="post">
            ...
            <div class="table_list">
                ...
                <div class="list">
                    ...
                    <input type="text" value="<?= $this->session->userdata('alamat') ?>" name="alamat" id="alamat"
                        readonly>
                </div>
                <div class="list">
                    <div class="labelInfo">
                    ...
                    <input type="text" value="<?= $this->session->userdata('telp') ?>" name="notelp" id="notelp"
                        readonly>
                </div>
                <div class="list">
                    <div class="labelInfo">
                    ...
                    <select name="pengiriman" class="form-select" id="pengiriman"
                        style='width: 65%; border: none;border: 2px solid #ddd;'>
                ...
                <tbody>
                    ...
                    <?php foreach ($this->cart->contents() as $items) { ?>
                        <tr>
                            ...
                            <td class="align-middle"><?php echo "Rp. " . number_format($items['price'], 0, ',', '.'); ?>
                            </td>
                    ...
                    <?php } ?>
                    <tr>
                        <th scope="col" colspan="4" style="background: #0dcaf0!important; color: #fff!important;">Total
                            Harga</th>
