...
(14, 'Rian Brury', 'Rian', '$2y$10$mlV7NdlaYJY9UaOMp.n3x.6ALHYdh49yz9MAfi6mqDJfojmNaztqy', 'JL.Margonda Raya', 'ryannanuru29@gmail.com', '081234567894');
...
(9, 'Cuci Express', 10000, 'paket1670801066.png');
...
('P0022', 14, '2024-06-11', 'baru', 'bayar_ditempat', 'belum_dibayar', NULL, 'tolak', '', 18),
('P0023', 14, '2024-06-12', 'selesai', 'bayar_ditempat', 'dibayar', NULL, 'setuju', '', 17),
('P0024', 14, '2024-06-12', 'baru', 'Pengantaran', 'belum_dibayar', NULL, 'setuju', '', 18),
...
(17, 'Rian', 'Rian', '$2y$10$Y9MKjTNz83on.z28GGwWsO7bD0lJf.latsG5shxaH3ZqnDXc9pG0S', 'ryannanuru29@gmail.com', '08512345678'),
(18, 'Raskita', 'Raskita Matilda', '$2y$10$mTvDyFwT3MmNtgTP.9Tssezv1ytUb3AHufFwZl4oI33SoATqdDtRG', 'raskita@gmail.com', '081122334455');
...
--
ALTER TABLE `tb_member`
  MODIFY `id_member` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
